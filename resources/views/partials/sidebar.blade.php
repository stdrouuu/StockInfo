<aside class="w-64 bg-white border-r border-slate-200 flex flex-col fixed h-[100dvh] z-40 transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:z-20 lg:transform-none"
    ...
    <nav class="flex-1 px-4 space-y-1 mt-2 sm:mt-4 overflow-y-auto hide-scrollbar flex flex-col" x-data="{ 
        ...
        <a href="{{ route('dashboard.dashboard') }}" 
           class="flex items-center gap-3 px-4 py-2 sm:py-2.5 rounded-xl transition-all group"
        ...
        <div class="space-y-1">
            <button @click="openSub = (openSub === 'produk' ? '' : 'produk')" 
               class="w-full flex items-center justify-between px-4 py-2 sm:py-2.5 rounded-xl transition-all group"
    ...
    <div class="p-4 border-t border-slate-100">
        <button @click="showLogoutModal = true" class="w-full flex items-center gap-3 px-4 py-2 sm:py-2.5 text-red-400 hover:bg-red-50 rounded-xl transition-all group">
