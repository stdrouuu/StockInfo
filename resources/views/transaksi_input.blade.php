...
@section('title', 'StockInfo - Input Transaksi Masuk')
        ...
        <div class="grid grid-cols-12 gap-8">
            <div class="col-span-12 md:col-span-7 space-y-6">
                <div class="space-y-2">
                    ...
                    <select class="w-full px-5 py-3 bg-[#f1f5f9] border-none rounded-xl text-sm font-medium text-slate-600 outline-none">
                        <option>Pilih Supplier</option>
                        <option selected>PT. Rimba Jaya Abadi</option>
                        <option>CV. Bangunan Sejahtera</option>
                    </select>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Kontak Person</label>
                        <input type="text" value="Hendra Setiawan" class="w-full px-5 py-3 bg-[#f1f5f9] border-none rounded-xl text-sm font-medium text-slate-600 outline-none" readonly>
                    </div>
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Tanggal Transaksi</label>
                        <input type="date" value="{{ date('Y-m-d') }}" class="w-full px-5 py-3 bg-[#f1f5f9] border-none rounded-xl text-sm font-medium text-slate-600 outline-none">
                    </div>
                </div>
            </div>
            <div class="col-span-12 md:col-span-5 space-y-2 flex flex-col h-full">
                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Keterangan Tambahan</label>
                <textarea class="flex-1 w-full px-5 py-4 bg-[#f1f5f9] border-none rounded-xl text-sm font-medium text-slate-600 outline-none resize-none min-h-[120px]">Pengiriman stok rutin bulanan. Kondisi material kering dan sudah diperiksa.</textarea>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                <div class="md:col-span-5 space-y-2">
                    ...
                    <select class="w-full px-5 py-3 bg-[#f1f5f9] border-none rounded-xl text-sm font-medium text-slate-600 outline-none">
                        ...
                        <option>Cat Tembok Putih 5Kg</option>
                        <option>Semen Padang 40Kg</option>
                    </select>
                </div>
